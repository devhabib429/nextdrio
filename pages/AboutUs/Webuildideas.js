...
const Webuildideas = () => {
    return (
        <div className="flex flex-col pt-16 min-h-screen">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-16">We Build Ideas into Reality</h1>
            <div className="px-4 md:px-8 lg:px-28">
                <p className="text-sm md:text-md lg:text-lg text-gray-600 text-left mb-8">
