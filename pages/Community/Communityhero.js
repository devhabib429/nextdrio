    ...
    return (
        <>
            ...
            <section className="h-screen p-4 md:p-8 lg:p-16 xl:p-20 bg-black flex flex-col md:flex-row items-center justify-center">
                <div className="flex flex-col justify-center mt-16 items-center md:items-start text-center md:text-left md:w-1/2 md:p-0 md:pr-8 lg:pr-16 xl:pr-20">
                ...
                <div className="flex justify-center items-center md:w-1/2 mt-8">
