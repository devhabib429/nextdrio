...
const Openhero = () => {
    ...
    return (
        <>
            ...
            <section className="p-4 sm:p-8 md:p-16 lg:p-20 xl:p-40 bg-indigo-300 mx-auto flex flex-col-reverse md:flex-row items-center justify-between space-y-8 md:space-y-0 md:space-x-64">
                {/* Column 1 */}
                <div className="w-full md:w-1/2 pt-8 md:pt-0 md:pr-8 lg:pr-12 xl:pr-20">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 md:mb-12">
                        {typedText}
                    </h2>
                    <p className="text-base md:text-lg lg:text-lg xl:text-xl mb-12">
