...
const OpenSourceThought = () => {
    return (
        <div className="p-8 md:p-16 bg-gradient-to-r from-indigo-300 to-indigo-500 rounded-lg text-white">
            <h2 className="text-xl md:text-3xl font-bold mb-8 md:mb-12 font-serif tracking-widest text-center md:text-left">Why Open Source?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 font-serif tracking-wide">
                <div className="flex items-center">
                    ...
                    <p className="text-base md:text-lg">Community-driven development</p>
                </div>
                <div className="flex items-center">
                    <FaCode className="text-3xl md:text-4xl mr-4" />
                    <p className="text-base md:text-lg">Transparent and accessible codebase</p>
                </div>
                <div className="flex items-center">
                    <FaTools className="text-3xl md:text-4xl mr-4" />
                    <p className="text-base md:text-lg">Flexible and customizable solutions</p>
                </div>
                <div className="flex items-center">
                    <FaGlobe className="text-3xl md:text-4xl mr-4" />
                    <p className="text-base md:text-lg">Global collaboration and innovation</p>
                </div>
                <div className="flex items-center">
                    <FaUsers className="text-3xl md:text-4xl mr-4" />
                    <p className="text-base md:text-lg">Community-driven development</p>
