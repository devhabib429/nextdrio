...
const Servicehero = () => {
    return (
        <>
            <section className="relative p-4 sm:p-8 md:p-16 lg:p-20 xl:p-40 bg-gray-100 mx-auto flex flex-col-reverse md:flex-row items-center justify-between space-y-8 md:space-y-0 md:space-x-8 lg:space-x-16 xl:space-x-32">
                <div className="w-full md:w-1/2 pt-16 md:pt-0">
                    <div className="text-center md:text-left">
                        <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-black mb-4 md:mb-8">
