...
function createPlaceholderImage(filename, text, color) {
  ...
  fs.writeFileSync(path.join(__dirname, '../public/images/services/ui-ux-design', filename), buffer);
}

// Create UI/UX Design directory if it doesn't exist
const uiuxDir = path.join(__dirname, '../public/images/services/ui-ux-design');
